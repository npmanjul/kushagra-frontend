...
import { ChevronRight, Printer, PrinterIcon } from "lucide-react";
...
const InfoItem = ({
  ...
  <div
    className={`group flex items-start gap-3 p-3 rounded-xl transition-all duration-300 hover:bg-gradient-to-r hover:from-slate-50 hover:to-blue-50/50 ${
      highlight
...
const ProfilePage = () => {
  ...
  const tabs = [
    ...
    },
    {
      id: "banking",
      label: "Banking",
      icon: <Icons.Bank className="h-4 w-4" />,
    },
  ];
          ...
          <div className="flex flex-col lg:flex-row items-center lg:items-end gap-6 lg:gap-8">
            ...
            <div className="flex-1 text-center lg:text-left space-y-3">
              <div className="flex flex-wrap items-center justify-center lg:justify-start gap-2">
                ...
                <button
                  onClick={() => handlePrint({data: profile, service: "profile"})}
              ...
              >
                <div className="grid grid-cols-1 md:grid-cols-2 gap-1">
                  ...
                  <InfoItem
                    icon={<Icons.Calendar className="h-4 w-4" />}
                    label="Date of Birth"
                    value={`${formatDate(profile?.dob)} (${calculateAge(
                      profile?.dob
                    )})`}
                  />
                  <InfoItem
            ...
            >
              <div className="grid grid-cols-1 md:grid-cols-2 gap-1">
                ...
                <InfoItem
                  ...
                  value={
                    profile?.account_number
                      ? `XXXXXX${profile.account_number.slice(-4)}`
                      : null
                  }
                />
                <InfoItem
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-amber-700 mt-1">
                      Ensure your bank details are correct for timely salary
                      processing.
                    </p>
                  </div>
                </div>
