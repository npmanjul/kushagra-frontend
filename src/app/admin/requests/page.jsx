...
const Request = () => {
  ...
  // Get overall approval status for display - ADMIN VIEW
  ...
  const getAwaitingAdminApproval = () => {
    return transactions.filter(t => {
      ...
      const adminApproval = getIndividualApprovalStatus(t.approval?.admin_approval);
      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-blue-50/30 flex items-center justify-center p-4">
        <div className="text-center">
          <div className="relative w-20 h-20 sm:w-24 sm:h-24 mx-auto">
            ...
            <div className="absolute inset-3 sm:inset-4 border-4 border-emerald-400 rounded-full border-b-transparent animate-spin" style={{ animationDirection: 'reverse', animationDuration: '1.5s' }}></div>
            <Shield className="absolute inset-0 m-auto w-8 h-8 text-blue-500 animate-pulse" />
          </div>
          <p className="mt-6 sm:mt-8 text-gray-800 font-semibold text-base sm:text-lg">Loading admin dashboard...</p>
  ...
  return (
    <div className="min-h-screen ">
      <div className="max-w-7xl mx-auto  space-y-4 sm:space-y-6">
        {/* Header Section - Light Professional Theme */}
        <div className="relative bg-white rounded-2xl sm:rounded-3xl shadow-xl shadow-gray-200/50 border border-gray-100 overflow-hidden">
          ...
          <div className="absolute inset-0 bg-gradient-to-r from-blue-50/50 via-transparent to-violet-50/50"></div>
          <div className="absolute top-0 right-0 w-64 sm:w-96 h-64 sm:h-96 bg-gradient-to-bl from-blue-100/40 to-transparent rounded-full -mr-32 sm:-mr-48 -mt-32 sm:-mt-48"></div>
          <div className="absolute bottom-0 left-0 w-48 sm:w-64 h-48 sm:h-64 bg-gradient-to-tr from-emerald-100/40 to-transparent rounded-full -ml-24 sm:-ml-32 -mb-24 sm:-mb-32"></div>
            ...
            <div className="flex flex-col gap-4 sm:gap-6">
              ...
              <div className="space-y-2 sm:space-y-3">
                <div className="flex flex-wrap items-center gap-2 sm:gap-3">
                  <span className="inline-flex items-center gap-1.5 sm:gap-2 px-3 sm:px-4 py-1 sm:py-1.5 bg-gradient-to-r from-blue-500 to-blue-600 text-white rounded-full text-xs sm:text-sm font-bold shadow-lg shadow-blue-200">
                  ...
                  <span className="px-2 sm:px-3 py-0.5 sm:py-1 bg-emerald-50 text-emerald-600 rounded-full text-xs font-medium flex items-center gap-1 border border-emerald-200">
                ...
                <p className="text-gray-600 text-sm sm:text-base md:text-lg max-w-xl">
                  Final approval authority for all transactions. Review and authorize after manager approval.
                </p>
              </div>
              ...
              <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 w-full">
                <div className="relative flex-1">
                  ...
                  <input
                    ...
                    className="w-full pl-10 sm:pl-12 pr-4 py-3 sm:py-3.5 bg-gray-50 border border-gray-200 rounded-xl sm:rounded-2xl focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-400 focus:bg-white transition-all duration-300 placeholder:text-gray-400 text-gray-800 text-sm sm:text-base shadow-sm"
                  />
                  {searchValue && (
                    <button
        ...
        {/* Statistics Cards - Light Professional Theme */}
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-2 sm:gap-3 md:gap-4">
          ...
          <StatCard
            title="Your Action"
            value={getAwaitingAdminApproval()}
            icon={<Crown className="w-4 h-4 sm:w-5 sm:h-5" />}
            gradient="from-blue-500 to-blue-600"
            bgColor="bg-blue-50"
            borderColor="border-blue-200"
            highlight={getAwaitingAdminApproval() > 0}
          />
          <StatCard
            title="Pending"
              ...
              <div className="flex items-center justify-center py-12 sm:py-16">
                <div className="flex flex-col items-center gap-3 sm:gap-4">
                  <div className="relative">
                    <div className="animate-spin rounded-full h-10 w-10 sm:h-12 sm:w-12 border-4 border-gray-200 border-t-blue-500"></div>
                  </div>
                      ...
                      if (startPage > 1) {
                        pages.push(
                          <button
                            key={1}
                            onClick={() => goToPage(1)}
                            className="px-2 sm:px-3 py-1 sm:py-1.5 rounded-lg text-xs sm:text-sm font-medium text-gray-600 hover:bg-blue-50 hover:text-blue-600 transition-all"
                          >
                            1
                          </button>
                        );
      ...
      <div className="flex items-start justify-between mb-1.5 sm:mb-2">
        ...
        {highlight && (
          <span className="flex h-2.5 w-2.5 sm:h-3 sm:w-3">
            <span className="animate-ping absolute inline-flex h-2.5 w-2.5 sm:h-3 sm:w-3 rounded-full bg-blue-400 opacity-75"></span>
    ...
    switch (statusFilter) {
      case 'pending':
        return {
          ...
          subtitle: 'All transactions have been processed. Excellent work!'
        };
      case 'completed':
        return {
    ...
    <div className="text-center py-12 sm:py-16 md:py-24">
      ...
      {searchValue && (
        <button
          ...
          className="mt-4 sm:mt-6 px-5 sm:px-6 py-2 sm:py-2.5 bg-blue-500 hover:bg-blue-600 text-white rounded-lg sm:rounded-xl font-medium shadow-md hover:shadow-lg transition-all text-sm sm:text-base active:scale-95"
        >
          Clear Search
        </button>
      )}
...
// Transaction Card Component - Light Professional Theme
  ...
  return (
    <div 
      className={`
        ...
        ${canAdminApprove 
          ? 'border-blue-300 hover:border-blue-400 shadow-lg shadow-blue-100/50' 
          : isRejected 
    ...
    >
      ...
      {canAdminApprove && (
        <div className="bg-gradient-to-r from-blue-500 to-blue-600 px-3 sm:px-4 py-2 sm:py-2.5">
          <div className="flex items-center gap-2 text-white">
            <Shield className="w-4 h-4 sm:w-5 sm:h-5" />
            <span className="text-xs sm:text-sm font-semibold">Final Approval Required - Manager has approved</span>
          </div>
        </div>
      )}
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 sm:gap-4 pt-3 sm:pt-4 border-t border-gray-100">
            ...
            <div className="flex items-center gap-2 w-full sm:w-auto">
              ...
              <button
                onClick={onView}
                className={`
                  ${canAdminApprove ? '' : 'flex-1 sm:flex-none'} 
...
// Approval Badge Component - Light Theme
const ApprovalBadge = ({ label, approvalData, isCurrentUser = false }) => {
  const getStatusStyles = () => {
    switch (approvalData.status) {
      ...
      default:
        return {
          bg: isCurrentUser ? 'bg-blue-50' : 'bg-gray-50',
          border: isCurrentUser ? 'border-blue-300' : 'border-gray-200',
          text: isCurrentUser ? 'text-blue-700' : 'text-gray-500',
  ...
  return (
    <div className={`
      ...
      ${isCurrentUser && approvalData.status === 'pending' ? 'ring-2 ring-blue-300 ring-offset-1 shadow-sm' : ''}
      transition-all duration-200
    `}>
      {isCurrentUser && approvalData.status === 'pending' && <Shield className="w-3 h-3 text-blue-600" />}
      {styles.icon}
      <span className="hidden xs:inline">{label}</span>
      <span className="xs:hidden">{label.slice(0, 3)}</span>
      {isCurrentUser && <span className="text-blue-500 text-[9px]">(You)</span>}
    </div>
  );
};
