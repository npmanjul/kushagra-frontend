...
export default function LandingPage() {
  ...
  const heroSlides = [
    ...
    },
    {
      ...
      description:
        "Get up to 60% instant loan against your stored grains. No collateral needed — your grain is your guarantee. Money directly in your bank account.",
      image: "/Hero_1.jpeg",
    },
    {
      ...
      description:
        "No more distress selling! Store your grain, wait for the right price, and sell with one click. We connect you to buyers across India.",
      image: "/Hero_3.png",
    },
  ];
    ...
    <div className="min-h-screen bg-white font-sans text-stone-900 selection:bg-emerald-100 selection:text-emerald-900 antialiased">
      ...
      <header className="fixed top-0 left-0 right-0 w-full z-50 shadow-lg">
        ...
        <nav className="bg-emerald-600 hidden lg:block shadow-inner">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex justify-center items-center h-12 gap-1">
              {navItems.map((item) => {
                ...
                return item === "Contact" ? (
                  ...
                  <Link
                    key={item}
                    href={`#${sectionId}`}
                    className={`text-[15px] font-semibold transition-all duration-200 px-4 py-1 rounded-full transform active:scale-95 hover:scale-105 ${
                      isActive
              ...
              {navItems.map((item) => {
                ...
                return (
                  <a
                    ...
                    className={`block py-2.5 px-4 text-sm font-semibold rounded-lg transition-all ${
                      isActive
          ...
          <div className="grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
            ...
            <div>
              <div className="text-emerald-600 font-bold text-sm tracking-widest uppercase mb-4">
                About Kushagra Bhumitra FPO
              </div>
              <h2 className="text-3xl lg:text-5xl font-bold text-stone-900 mb-6 leading-tight">
                Your Grain, <br />
                <span className="text-emerald-600">Your Bank.</span>
              </h2>
              <div className="space-y-5 text-base lg:text-lg text-stone-600 leading-relaxed">
                <p className="text-justify">
                  <strong className="text-stone-900 text-justify">
                    Kushagra Bhumitra Bio Energy Farmer Producer Company Limited
                  </strong>{" "}
                  is a revolutionary Agri-FinTech platform that empowers farmers
                  by digitizing their grain assets. We provide scientifically
                  managed warehouses at the village level, eliminating the need
                  for farmers to travel to distant mandis.
                </p>
                <p className="text-justify">
                  किसान अब अपने अनाज को सुरक्षित गोदाम में जमा कर सकते हैं और
                  उसके बदले{" "}
                  <span className="bg-amber-100 px-1 font-semibold text-stone-800">
                    60% तक तत्काल लोन
                  </span>{" "}
                  प्राप्त कर सकते हैं। जब भी चाहें, अपनी मर्ज़ी से, सही दाम पर
                  बेच सकते हैं।
                </p>
                <p>
                  ...
                  . We bridge the gap between traditional farming and modern
                  financial services.
                </p>
              </div>
            </div>
      ...
      <section className="py-15  bg-stone-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <div className="text-emerald-600 font-bold text-sm tracking-widest mb-3">
              The Gap We Bridge
            </div>
            <h3 className="text-3xl lg:text-5xl font-bold text-stone-900">
              Farmer Challenges <span className="text-emerald-600">Solved</span>
            </h3>
          </div>
            ...
            <div className="bg-white p-8 lg:p-10 rounded-3xl shadow-sm border border-stone-100">
              <div className="flex items-center gap-4 mb-8">
                ...
                <div>
                  ...
                  <p className="text-stone-400 text-sm">
                    Problems farmers face every season
                  </p>
                </div>
              </div>
              <ul className="space-y-5">
                {[
                  ...
                  >
                    <div className="w-6 h-6 shrink-0 rounded-full bg-red-100 text-red-500 flex items-center justify-center font-bold text-xs mt-0.5">
                      ✕
                    </div>
                    <div>
              ...
              <div className="relative z-10">
                ...
                <ul className="space-y-5">
                  {[
                    ...
                    >
                      <div className="w-6 h-6 shrink-0 rounded-full bg-emerald-500 text-white flex items-center justify-center font-bold text-xs mt-0.5">
                        ✓
                      </div>
                      <div>
      ...
      <section id="how-it-works" className="py-15 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <div className="text-emerald-600 font-bold text-sm tracking-widest uppercase mb-3">
              The Process
            </div>
            <h3 className="text-3xl lg:text-5xl font-bold text-stone-900 mb-4">
              How Grainbank Works
            </h3>
            <p className="text-stone-500 max-w-2xl mx-auto text-lg">
              A simple, transparent, and technology-driven process from farm to
              finance.
            </p>
            ...
            <div className="animate-fadeIn">
              <div className="bg-emerald-900 rounded-3xl p-8 lg:p-12 text-white mb-8">
                ...
                <p className="text-emerald-200 max-w-2xl">
                  Kushagra Bhumitra FPO's operations are backed by a comprehensive tech platform.
                  Farmers can easily access their digital inventory, check the
                  current offer price, and make transactions with just one
                  click.
                </p>
              </div>
                ...
                {[
                  ...
                  <Link
                    ...
                    className={`bg-stone-50 p-6 rounded-2xl border border-stone-100 hover:border-emerald-200 hover:shadow-lg transition-all group ${
                      item.title === "Register & Book" ? "cursor-pointer" : "cursor-none"
                    }}`}
                    href={item.title === "Register & Book" ? "/register" : "#"}
                  >
                    <div className="flex items-center justify-between mb-4">
                      <item.icon className="w-10 h-10 text-emerald-600" />
                      <span className="text-4xl font-black text-stone-200 group-hover:text-emerald-200 transition-colors">
                        {item.step}
                      </span>
                    </div>
                    <h5 className="text-lg font-bold text-stone-900 mb-2">
                      {item.title}
                    </h5>
          ...
          {activeTab === "buyer" && (
            <div className="animate-fadeIn">
              <div className="bg-blue-900 rounded-3xl p-8 lg:p-12 text-white mb-8">
                <h4 className="text-2xl font-bold mb-3 flex items-center">
                  <Handshake className="w-6 h-6 mr-3 text-blue-300" />
                  Buyer Advantages (खरीदार के लाभ)
                </h4>
                <p className="text-blue-200 max-w-2xl">
                  Our platform serves as a gateway, providing access to 1.5 lakh
                  farmers and offering a substantial quantity of quality grains.
                  Our "everyday low-price" offer ensures affordability for all
                  buyers involved.
                </p>
              </div>
                ...
                {[
                  ...
                  >
                    <div className="flex items-center justify-between mb-4">
                      ...
                      <span className="text-4xl font-black text-stone-200 group-hover:text-blue-200 transition-colors">
                        {item.step}
                      </span>
                    </div>
                    <h5 className="text-lg font-bold text-stone-900 mb-2">
      ...
      <section id="plans" className="py-15 bg-stone-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-stone-500 max-w-2xl mx-auto text-lg">
              No hidden fees. Clear terms. Maximum benefit for the farmer.
            </p>
          </div>
          ...
          <div className="grid lg:grid-cols-5 gap-6 lg:gap-8">
            ...
            <div className="lg:col-span-3 bg-white p-8 lg:p-10 rounded-3xl shadow-xl border border-stone-100 relative overflow-hidden">
              <div className="absolute top-0 right-0 bg-stone-900 text-white text-[10px] sm:text-xs font-bold px-3 sm:px-5 py-1.5 sm:py-2 rounded-bl-2xl uppercase tracking-wider">
                Recommended
              </div>
              <h4 className="text-xl sm:text-2xl font-bold text-stone-900 mb-2 flex items-center">
                <Sprout className="w-5 h-5 sm:w-6 sm:h-6 mr-2 sm:mr-3 text-emerald-500" />
                Price Return Policy
              </h4>
              <p className="text-stone-500 mb-8">
                Sell your grains anytime and get MSP + Extra based on your
                storage duration.
              </p>
              ...
              <div className="grid sm:grid-cols-2 gap-6 mb-8">
                <div className="p-6 bg-emerald-50 rounded-2xl border border-emerald-100">
                  ...
                  <div className="text-3xl sm:text-4xl font-black text-stone-900 mt-2">
                    MSP + <span className="text-emerald-600">20%</span>
                  </div>
                  <p className="text-sm text-stone-500 mt-2">
                    Maximum profitability for patient investors.
                  </p>
                </div>
                <div className="p-6 bg-stone-100 rounded-2xl border border-stone-200">
                  ...
                  <div className="text-3xl sm:text-4xl font-black text-stone-900 mt-2">
                    MSP + <span className="text-stone-400">10%</span>
                  </div>
                  <p className="text-sm text-stone-500 mt-2">
                    Still better than distress selling at harvest.
                  </p>
                </div>
              </div>
              ...
              <div className="p-5 bg-amber-50 rounded-xl border border-amber-100 flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-stone-600">
                    If Wheat MSP in 2029 is ₹2910/quintal, with 15% extra, you
                    receive <strong>₹3346.50/quintal</strong>. This is
                    significantly higher than typical mandi rates.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="lg:col-span-2 grid grid-cols-2 gap-4">
              {[
                ...
                >
                  ...
                  <span className="block text-3xl font-black text-stone-900">
                    {item.value}
                  </span>
                  <span className="block text-xs font-semibold text-stone-400 uppercase mt-1">
                    {item.label}
                  </span>
      ...
      <section id="team" className="py-15 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <h3 className="text-3xl lg:text-5xl font-bold text-stone-900">
              Board of <span className="text-emerald-600">Directors</span>
            </h3>
          </div>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              >
                ...
                <h4 className="text-xl font-bold text-stone-900 mb-0.5 group-hover:text-emerald-600 transition-colors">
                  {member.name}
                </h4>
      ...
      <section id="news" className="py-15 bg-stone-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <div className="text-stone-400 font-bold text-sm tracking-widest uppercase mb-3">
              Press Talk
            </div>
            <h3 className="text-3xl lg:text-5xl font-bold text-emerald-700">
            ...
            {[
              {
                ...
                quote:
                  "Agritech start-up, Ergos bags additional funding of US$ 3million from London based CDC Group Plc in its Series A round.",
              },
              {
                ...
                author: "ETTech",
                quote:
                  "Agritech startup Ergos Business Solutions has raised Rs 38.5 crore in Series A funding from Chiratae Ventures and Aavishkar Capital.",
              },
              {
                ...
                quote:
                  "Agritech Startup Ergos Raises $5 Million From Chiratae Ventures And Aavishkaar Capital for expanding its grain storage network.",
              },
            ].map((item, idx) => (
              <div
                key={idx}
      ...
      <section id="contact" className="py-15 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <h3 className="text-3xl lg:text-4xl font-bold text-stone-900 mb-3">
              Get in Touch
            </h3>
      ...
      <footer className="bg-stone-900 text-stone-400 py-10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
            ...
            <div className="lg:col-span-1">
              <a href="#" className="flex items-center gap-3 group mb-4">
                ...
                <div>
                  ...
                  <div className="text-[10px] font-bold text-emerald-400 tracking-[0.2em] uppercase mt-0.5">
                    Bhumitra FPO
                  </div>
                </div>
              </a>
              <p className="text-stone-500 text-sm leading-relaxed">
                Empowering farmers through technology. Safe storage, instant
                credit, and best market prices.
              </p>
            </div>
            ...
            <div className="lg:flex lg:justify-center lg:tems-center flex-col ">
              ...
              <ul className="space-y-3 text-sm">
                {["About Us", "How It Works", "Plans", "Team", "Contact"].map(
                  (link) => (
                    <li key={link}>
                      <a
            ...
            <div>
              ...
              <ul className="space-y-3 text-sm">
                ...
                <li className="flex items-start gap-3">
                  ...
                  <p>
                    Jangal Subhan Ali (Tameshwar Chowk) Unaula, Road/Street -
                    Pipraich Road, Gorakhpur, 273152 (U.P), INDIA
                  </p>
                </li>
              </ul>
            </div>
          ...
          <div className="border-t border-stone-800 pt-4 text-center text-sm">
            © {new Date().getFullYear()} Kushagra Bhumitra Bio Energy Farmer
            Producer Company Limited. All rights reserved.
          </div>
        </div>
      </footer>
    </div>
