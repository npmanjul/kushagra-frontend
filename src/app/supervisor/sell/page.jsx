...
const SellPage = () => {
    ...
    try {
      ...
      const normalized = deposits
        .map(d => ({
          ...
          today_price_per_quintal: d.today_price_per_quintal ?? 0,
          total_value: d.total_value ?? 0,
          warehouse_name: d.warehouse_name || "Main",
  ...
  const processSale = async () => {
    if (!sellQuantity || !selectedWarehouse) {
      toast.error("Please fill all required fields");
      return;
    }

    if (parseFloat(sellQuantity) > parseFloat(selectedInventoryItem.quantity)) {
      toast.error("Sell quantity cannot exceed available quantity");
      return;
    }
    ...
    try {
      ...
      const response = await fetch(`${API_BASE_URL}/transaction/sell`, {
        method: "POST",
        headers: {
  ...
  const calculateTotalAmount = () => {
    if (!sellQuantity || !todayPrice?.price) return 0;
    return (parseFloat(sellQuantity) * parseFloat(todayPrice.price)).toFixed(2);
  };
  ...
  const ConfirmSaleModal = () => {
    ...
    const selectedWarehouseObj = warehouses.find(w => w._id === selectedWarehouse);
    const remainingQty = selectedInventoryItem
      ? (parseFloat(selectedInventoryItem.quantity) - parseFloat(sellQuantity || 0)).toFixed(2)
      : "0";
          ...
          <div className="p-6 md:p-8">
            ...
            <div className="flex items-center justify-between mb-6">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="text-2xl font-bold text-gray-900">Confirm Sale</h3>
                  <p className="text-sm text-gray-500 mt-0.5">Review all details before confirming</p>
                </div>
              </div>
              <button
                onClick={() => setShowConfirmModal(false)}
            ...
            <div className="space-y-4">
              ...
              <div className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-2xl p-5 border border-blue-100">
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
                  ...
                  <InfoItem label="Warehouse" value={selectedWarehouseObj?.name || "-"} />
                  <InfoItem label="Location" value={selectedWarehouseObj?.location || "-"} />
                </div>
              </div>
              ...
              <div className="bg-gradient-to-br from-purple-50 to-pink-50 rounded-2xl p-5 border border-purple-100">
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
                  ...
                  <InfoItem label="Available" value={`${selectedInventoryItem?.quantity} Qtl`} />
                  <InfoItem label="Selling" value={`${sellQuantity || 0} Qtl`} highlight />
                ...
                <div className="space-y-2">
                  <div className="flex justify-between items-center py-2">
                    ...
                    <span className="text-gray-900 font-medium">
                      {sellQuantity || 0} × ₹{todayPrice?.price || 0}
                    </span>
                  </div>
              ...
              <div className="flex gap-3 p-4 bg-amber-50 border border-amber-200 rounded-xl">
                ...
                <p className="text-sm text-amber-800">
                  This action will deduct {sellQuantity || 0} quintals from the farmer's inventory. 
            ...
            <div className="flex gap-3 mt-6">
              ...
              <button
                ...
                className="flex-1 py-3.5 px-6 rounded-xl font-semibold bg-gradient-to-r from-emerald-600 to-green-600 text-white hover:from-emerald-700 hover:to-green-700 transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2 shadow-lg"
              >
                {isProcessing ? (
                  <>
  ...
  const InfoItem = ({ label, value, highlight }) => (
    <div className={`${highlight ? 'bg-white/80' : 'bg-white/50'} rounded-xl p-2.5`}>
      ...
      <p className={`font-semibold truncate ${highlight ? 'text-emerald-600' : 'text-gray-900'}`}>
        {value || "-"}
      </p>
    </div>
  );
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-emerald-50/30">
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-1/4 -left-20 w-72 h-72 bg-emerald-200 rounded-full mix-blend-multiply filter blur-3xl opacity-30 animate-float" />
        <div className="absolute top-3/4 -right-20 w-72 h-72 bg-blue-200 rounded-full mix-blend-multiply filter blur-3xl opacity-30 animate-float animation-delay-2000" />
        <div className="absolute bottom-1/4 left-1/3 w-72 h-72 bg-purple-200 rounded-full mix-blend-multiply filter blur-3xl opacity-30 animate-float animation-delay-4000" />
      </div>
      ...
      <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8 py-6 lg:py-8 max-w-7xl">
          ...
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-gray-600 mt-1">Process grain sales from farmer inventory</p>
              </div>
            </div>
            ...
            <div className="hidden lg:flex items-center bg-gradient-to-r from-gray-50 to-gray-100 rounded-2xl p-2">
              {[
                ...
                { step: 2, label: "Select Inventory", icon: Package },
                { step: 3, label: "Confirm Sale", icon: CreditCard }
              ].map((item, index) => (
                <div key={item.step} className="flex items-center">
                  <div className={`flex items-center px-4 py-2.5 rounded-xl transition-all duration-500 ${
                    ...
                    <div className={`relative flex items-center justify-center w-10 h-10 rounded-xl transition-all duration-500 ${
                      ...
                      {currentStep === item.step && (
                        <div className="absolute -inset-0.5 bg-gradient-to-r from-emerald-500 to-green-600 rounded-xl blur opacity-30 animate-pulse" />
                      )}
                    </div>
                  ...
                  {index < 2 && (
                    <ChevronRight className={`h-5 w-5 mx-2 transition-all duration-500 ${
                      currentStep > item.step ? 'text-emerald-500' : 'text-gray-300'
                    }`} />
                  )}
                </div>
              ))}
              ...
              {[1, 2, 3].map((step) => (
                <div
                  ...
                  className={`h-2 rounded-full transition-all duration-500 ${
                    currentStep >= step
                      ? 'w-12 bg-gradient-to-r from-emerald-500 to-green-600'
                      : 'w-2 bg-gray-300'
                  }`}
                />
              ))}
        ...
        <div className="bg-white/80 backdrop-blur-xl rounded-3xl shadow-xl border border-white/50 p-6 lg:p-8 mb-6">
          <div className="flex items-center gap-3 mb-6">
            ...
            {selectedUser && (
              <span className="ml-auto px-4 py-1.5 bg-emerald-100 text-emerald-700 rounded-full text-sm font-medium flex items-center gap-1.5">
          ...
          {!selectedUser ? (
            ...
            <div className="bg-gradient-to-br from-emerald-50 to-green-50 rounded-2xl border-2 border-emerald-200 p-6 animate-fadeIn">
        ...
        {selectedUser && currentStep >= 2 && (
          <div className="bg-white/80 backdrop-blur-xl rounded-3xl shadow-xl border border-white/50 p-6 lg:p-8 mb-6 animate-fadeIn">
            <div className="flex items-center gap-3 mb-6">
              ...
              <h2 className="text-xl font-bold text-gray-800">Select Inventory</h2>
              {selectedInventoryItem && (
                ...
                <div className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-2xl p-6 border border-blue-200">
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex justify-between items-center py-2 border-t border-blue-200/50 pt-3">
                      ...
                      <span className="font-bold text-emerald-600 text-lg">{selectedInventoryItem.quantity} Qtl</span>
                    </div>
                  </div>
                </div>
              ...
              <div className="space-y-4">
                ...
                <div>
                  <label className="block text-sm font-semibold text-gray-700 mb-2">
                    Sell Quantity (Quintal) <span className="text-red-500">*</span>
                  </label>
                  <div className="relative">
                    <input
                      type="number"
                      ...
                      step="0.01"
                      className="w-full px-4 py-3.5 pr-16 bg-white border-2 border-gray-200 rounded-xl focus:ring-4 focus:ring-emerald-500/10 focus:border-emerald-500 transition-all duration-200 text-lg font-medium"
                      ...
                      <div className="flex items-start gap-2">
                        ...
                        <div className="flex-1 text-sm">
                          <p className="text-blue-800 font-medium">
                            Remaining after sale: {(parseFloat(selectedInventoryItem.quantity) - parseFloat(sellQuantity)).toFixed(2)} Qtl
                          </p>
                          {parseFloat(sellQuantity) > parseFloat(selectedInventoryItem.quantity) * 0.8 && (
                            <p className="text-blue-600 text-xs mt-1">
                              You're selling more than 80% of available stock
                            </p>
                          )}
                        </div>
                      </div>
                ...
                <div>
                  ...
                  <div className="relative">
                    <Warehouse className="absolute left-4 top-1/2 transform -translate-y-1/2 h-5 w-5 text-gray-400" />
                    <select
                      className="w-full pl-12 pr-10 py-3.5 bg-white border-2 border-gray-200 rounded-xl focus:ring-4 focus:ring-emerald-500/10 focus:border-emerald-500 transition-all duration-200 appearance-none cursor-pointer text-gray-900 font-medium"
                ...
                {/* Summary Card */}
                {sellQuantity && todayPrice && (
                  <div className="bg-gradient-to-br from-amber-50 to-orange-50 rounded-2xl p-6 border border-amber-200 animate-slideUp">
                    <h3 className="font-semibold text-gray-700 mb-4 flex items-center gap-2">
                    ...
                    <div className="space-y-3">
                      <div className="flex justify-between items-center">
                        ...
                        <span className="font-medium text-gray-900">{sellQuantity} Quintal</span>
                      </div>
                      <div className="flex justify-between items-center">
                      ...
                      <div className="border-t border-amber-200 pt-3">
                        <div className="flex justify-between items-center">
                          ...
                          <div className="text-right">
                            ...
                            <p className="text-xs text-gray-500 mt-0.5">Including all charges</p>
                          </div>
                        </div>
                      </div>
                    </div>
                ...
                <div className="flex gap-3 pt-2">
                  ...
                  <button
                    ...
                    disabled={!sellQuantity || !selectedWarehouse || isProcessing}
                ...
                <div className="flex gap-3 p-4 bg-gray-50 rounded-xl border border-gray-200">
                  ...
                  <div className="flex-1">
                    <p className="text-xs text-gray-600 leading-relaxed">
                      This transaction is secured and will be recorded permanently. 
                      All sales are subject to verification and approval.
                    </p>
                  </div>
                </div>
              </div>
